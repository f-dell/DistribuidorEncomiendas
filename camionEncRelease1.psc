		...
		Repetir
			...
			FinSi
				Si acuPeso > 200 y numCamion <= 2 Entonces					
					...
					cargaCamion <- acuPeso
					cargaDisponibeCam <- 200 - cargaCamion
					Mostrar "El camion numero ",numCamion, " tiene una disponibilidad de carga de ", cargaDisponibeCam, " Kg"			
					numCamion <- numCamion + 1
				FinSi				
				Si numCamion > 1 y cargaDisponibeCam > pesoEncomienda
					Mostrar "El camion ", numCamion - 1, " tiene una carga disponible de ", cargaDisponibeCam, " y puede alojar esta encomienda"
					Mostrar "Se asigna la carga al camion numero ", numCamion - 1
					Mostrar "El camion ", numCamion - 1, " tiene una carga acumulada de ", acuPeso + pesoEncomienda, " en ", cantEncom, " encomiendas"
				FinSi
				Si numCamion > 1 y cargaDisponibeCam < pesoEncomienda
